...
export default function Home() {
  ...
  const loadLatestMenu = async () => {
    ...
    try {
      ...
      // Cargar el menú más reciente por fecha de actualización, no por semana
      ...
      if (data && data.length > 0) {
        ...
        if (Object.keys(processedData).length > 0) {
          ...
          // Guardar el menú en localStorage para persistencia
          try {
            ...
            localStorage.setItem('currentMenuId', String(data[0].id));
          } catch (e) {
